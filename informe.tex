...
\begin{table}
    ...
    \hline
    \multirow{2}{*}{\parbox{4em}{Manejador interno de distribución de locks}} & Estructura de datos sin lock & 223 (PlusCal) & Incrementó la confianza. No encontró un bug de liveness ya que no se chequeaba liveness (esto no se si vale la pena ponerlo o no)\\
    \cline{2-4}
